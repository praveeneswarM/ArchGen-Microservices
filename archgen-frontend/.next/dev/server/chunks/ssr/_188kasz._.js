...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerUser"])(username, password, email);
            setSuccess(true);
            setTimeout(()=>{
                router.push("/login");
            }, 1500);
...
//# sourceMappingURL=_188kasz._.js.map