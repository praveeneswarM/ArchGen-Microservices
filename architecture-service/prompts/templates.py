...
1. Design a complete visual networking hierarchy boundaries. The returned nodes list MUST contain parent container nodes:
   - "region-group" (type: "RegionGroupNode", width: 2900, height: 1780)
   - "rg-group" (type: "ResourceGroupNode", parentNode: "region-group", width: 2840, height: 1690)
   - "vnet-group" (type: "VNetGroupNode", parentNode: "rg-group", width: 2780, height: 1600)
   - Subnets (type: "SubnetGroupNode", parentNode: "vnet-group"). You MUST create exactly these 5 subnets:
     * "subnet-ingress" (Ingress Subnet, x: 40, y: 60, width: 700, height: 400)
     * "subnet-mgmt" (Management Subnet, x: 780, y: 60, width: 1000, height: 600)
